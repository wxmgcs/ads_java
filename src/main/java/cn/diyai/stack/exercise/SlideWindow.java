...
public class SlideWindow {
    ...
    @Test
    public void test(){
        Assert.assertEquals("[5, 5, 5, 4, 6, 7]",Arrays.toString(slide(new int[]{4,3,5,4,3,3,6,7},8,3)));
        Assert.assertEquals("[5, 5, 5, 6, 7]",Arrays.toString(slide(new int[]{4,3,5,4,3,3,6,7},8,4)));
        Assert.assertEquals("[5, 5, 6, 7]",Arrays.toString(slide(new int[]{4,3,5,4,3,3,6,7},8,5)));
    }
}

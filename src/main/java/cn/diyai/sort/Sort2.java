...
/* 1*/      for( int p = 1; p < a.length; p++ )
        {
/* ll2*/          java.lang.Comparable tmp = a[ p ];
...
/* ll2*/          for( int i = gap; i < a.length; i++ )
            {
...
/* 1*/      if( left + CUTOFF <= right )
        {
/* ll2*/          java.lang.Comparable pivot = median3( a, left, right );
...
/* 1*/      if( left + CUTOFF <= right )
        {
/* ll2*/          Comparable pivot = median3( a, left, right );
...
/*15*/          insertionSort( a, left, right );
    ...
    public static void main( String [ ] args )
    {
        ...
        for( theSeed = 0; theSeed < 20; theSeed++ )
        {
            ...
            Random.permute( a );
            Sort2.quickSelect( a, NUM_ITEMS / 2 );

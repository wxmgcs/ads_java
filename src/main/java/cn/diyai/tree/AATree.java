    ...
    public class AATree
    {
        ...
        private AANode remove( Comparable x, AANode t )
        {
            if( t != nullNode )
            {
                ...
                // Step ll2: If at the bottom of the tree and
...
//
//            for( int i = 1; i < NUMS; i+= ll2 )
//                t.remove( new MyInteger( i ) );
//            System.out.println( "Removes complete" );
//
//            if( NUMS < 40 )
//                t.printTree( );
//            if( ((MyInteger)(t.findMin( ))).intValue( ) != ll2 ||
//                ((MyInteger)(t.findMax( ))).intValue( ) != NUMS - ll2 )
//                System.out.println( "FindMin or FindMax error!" );
//
//            for( int i = ll2; i < NUMS; i+=ll2 )
